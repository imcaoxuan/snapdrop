...
class ReceiveDialog extends Dialog {
    ...
    _displayFile(file) {
        ...
        if(file.mime.split('/')[0] === 'image'){
            ...
            this.$el.querySelector('#img-preview').removeAttribute('hidden');
            this.$el.querySelector("#img-preview").src = url;
        }
        if(file.mime.split('/')[0] === 'video'){
            console.log('the file is video');
            this.$el.querySelector('.preview').style.visibility = 'inherit';
            this.$el.querySelector('#video-preview').removeAttribute('hidden');
            this.$el.querySelector("#video-preview").src = url;
        }
    ...
    hide() {
        ...
        this.$el.querySelector('#img-preview').setAttribute('hidden', "true");
        this.$el.querySelector("#video-preview").src = "";
        this.$el.querySelector('#video-preview').setAttribute('hidden', "true");
        super.hide();
        this._dequeueFile();
    }
...
class WebShareTargetUI {
    constructor() {
        ...
        console.log('分享文本:', '"' + shareTargetText + '"');
    }
}
